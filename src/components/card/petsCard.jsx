...
export default function PetCard() {
    return <div className='border hover:border-red-300 cursor-pointer inline-block rounded-lg'>
        ...
        <div className='p-3'>
            ...
            <div className='font-normal text-sm text-red-400 pb-3 mb-3 border-b-2'>Dog</div>
